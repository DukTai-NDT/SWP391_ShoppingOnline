                                    ...
                                    <form action="EditCategory" method="post">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="${category.categoryID}" name="id" id="id" type="text" class="form-control" style="width: 750px" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Category Name</label>
                                                <input value="${category.categoryName}" name="categoryname" id="categoryname" type="text" class="form-control" style="width: 750px">
                                            </div>
                                        </div><!--end col-->
