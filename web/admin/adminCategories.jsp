                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="search-bar p-0 d-none d-md-block ms-2">
                                <div id="search" class="menu-search mb-0">
                                    <form role="search" method="get" id="searchform" class="searchform" action="SearchCategories">
                                        <div>
                                            <input type="text" class="form-control border rounded-pill" name="txt" id="txt" placeholder="Search Name...">
