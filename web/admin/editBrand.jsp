                                    ...
                                    <form action="EditBrand" method="post">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="${vector.brandID}" name="id" id="id" type="text" class="form-control" style="width: 750px" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Brand Name</label>
                                                <input value="${vector.brandName}" name="brandName" id="categoryname" type="text" class="form-control" style="width: 750px">
                                            </div>
                                             <div class="mb-3">
                                                <label class="form-label">Country</label>
                                                <input value="${vector.country}" name="country" id="categoryname" type="text" class="form-control" style="width: 750px">
                                            </div>
                                        </div><!--end col-->
