                    ...
                    <div class="col-lg-5 col-md-8">
                        ...
                        <div class="card login-page bg-white shadow mt-4 rounded border-0">
                            <div class="card-body">
                                ...
                                <form action="index.jsp" class="login-form mt-4">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3 text-center">
                                                <img src="images/doctors/01.jpg" class="avatar avatar-md-md rounded-pill mx-auto d-block shadow" alt="">

                                                <div class="mt-3">
                                                    <h5 class="mb-1">Dr. Calvin Carlo</h5>
