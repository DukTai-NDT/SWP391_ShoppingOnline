    ...
    <body>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="search-bar p-0 d-none d-md-block ms-2">
                                <div id="search" class="menu-search mb-0">
                                    <form role="search" method="get" id="searchform" class="searchform" action="SearchBrand">
                                        <div>
                                            <input type="text" class="form-control border rounded-pill" name="txt" id="txt" placeholder="Search Brand...">
                                            ...
                                            <c:forEach items="${vectorbrand}" var="brand">
                                                <tr>
                                                    ...
                                                    <td class="text-end p-3"> 
                                                        ...
                                                        <a href="DeleteBrand?cid=${brand.brandID}" 
                                                           class="btn btn-icon btn-pills btn-soft-danger"
                                                           onclick="return confirmDelete(event, '${brand.brandID}')">
        ...
        <script>
            function confirmDelete(event, brandID) {
                ...
                if (confirmation) {
                    window.location.href = "DeleteBrand?cid=" + brandID; // Chuyển hướng nếu xác nhận
                }
            }
        </script>
        <script>
