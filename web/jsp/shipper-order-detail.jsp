...
<%@page import="entity.Products,java.util.Vector, entity.Categories, entity.CartItems, entity.Orders, model.DAOOrders, model.DAOProvinces, model.DAODistricts,  model.DAODeliveryAddress, model.DAOPayments" %>
            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    ...
                    <ul class="sidebar-menu pt-3">
                        ...
                        <li class="sidebar-dropdown">
                            <a href=""><i class="uil uil-coins me-2 d-inline-block"></i>Order received</a>
                        </li>
                        <li class="sidebar-dropdown">
                            <a href="Dashboard"><i class="uil uil-coins me-2 d-inline-block"></i>Order finished</a>
                        </li>
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb" class="d-inline-block mt-1">
                                    <ul class="breadcrumb breadcrumb-muted bg-transparent rounded mb-0 p-0">
                                        <li class="breadcrumb-item"><a href="index.jsp">Shipper</a></li>
                            ...
                            <div class="col-12 mt-4">
                                <div class="table-responsive shadow rounded">
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                <th class="border-bottom p-3" style="min-width: 180px;">OrderID</th>
                                                <th class="border-bottom p-3" style="max-width: 180px;">Total</th>
                                                <th class="border-bottom p-3"style="min-width: 180px;">Address</th>
                                                <th class="border-bottom p-3" style="min-width: 180px;">Phone</th>
                                                <th class="border-bottom p-3" style="min-width: 180px;">Status</th> 
                                                <th class="border-bottom p-3" style="min-width: 180px;">Action</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-3"><%=deli.getDeliveryAddress("select * from DeliveryAddress where OrderID = " + order.getOrderID()).get(0).getPhone()%></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="order-actions">
                                                        <a href="ShipperDashBoardURL?service=finshedTranspoted&orderid=<%=order.getOrderID()%>" class="btn btn-success">Transported</a>
                                                    </div>
                                                    <% } else { %>
                                                    <div class="order-actions">
