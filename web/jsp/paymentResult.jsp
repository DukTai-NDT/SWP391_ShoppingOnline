...
<body style="background-color: #f4f4f4; font-family: Arial, sans-serif; margin: 0; padding: 20px;">
    ...
    <section style="margin-top: 50px; text-align: center;">
     ...
     <section style="margin-top: 50px; text-align: center;">
        <!-- Existing transaction status messages -->

        <div style="margin-top: 30px;">
            <a href="index.jsp" 
               style="display: inline-block; padding: 10px 20px; font-size: 18px; color: white; background-color: #007bff; text-decoration: none; border-radius: 5px;">
                Quay về trang chủ
            </a>
        </div>
    </section>
