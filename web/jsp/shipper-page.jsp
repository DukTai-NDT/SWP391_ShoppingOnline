...
<!DOCTYPE html>
<html lang="en">
    <%@page import="entity.Products,java.util.Vector, entity.Categories, entity.CartItems, entity.Customers,entity.Account, model.DAOOrders" %>
    <head>
        <meta charset="utf-8" />
                            ...
                            <div class="col-md-6 mt-4">
                                <div class="card features feature-primary rounded border-0 shadow p-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h5 class="mb-0"><%=dao.getNumberOrder()%></h5>
                            ...
                            <div class="col-md-6 mt-4">
                                <div class="card features feature-primary rounded border-0 shadow p-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h5 class="mb-0"><%=dao.getNumberOrderReceived(account.getAccountID())%></h5>
                                            <p class="text-muted mb-0">Order Received</p>
                                        </div>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 mt-4">
                                <div class="card features feature-primary rounded border-0 shadow p-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1 ms-2">
                                            <h5 class="mb-0"><%=dao.getNumberOrderFinished(account.getAccountID())%></h5> <!-- S? l??ng s?n ph?m ?ã bán -->
