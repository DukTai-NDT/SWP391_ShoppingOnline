...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .swiper-pagination {
                ...
                bottom: 0;
                margin-top: 15px; /* T?o kho?ng c?ch v?i slider */
            }

            /* T?y ch?nh m?u s?c v? k?ch th??c pagination */
            ...
            .swiper-pagination-bullet-active {
                background: #0056b3; /* M?u xanh ??m khi active */
                opacity: 1;
            }
            /*
            /* Canh ch?nh n?t ?i?u h??ng */
            ...
            .card {
                border: 2px solid #e0e0e0; /* Vi?n m?u x?m nh?t */
                border-radius: 10px; /* Bo tr?n g?c */
                box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* ?? b?ng nh? */
                transition: all 0.3s ease-in-out;
            }

            /* Hi?u ?ng khi di chu?t v?o s?n ph?m */
            .card:hover {
                border-color: #007bff; /* Vi?n chuy?n sang m?u xanh n??c bi?n */
                box-shadow: 0 4px 12px rgba(0, 123, 255, 0.3); /* Hi?u ?ng ?? b?ng m?u xanh */
                transform: scale(1.05); /* Ph?ng to nh? */
            }
            ...
            /* Khi di chu?t v?o card, ??i vi?n sang m?u xanh */
            .card1:hover {
                border-color: #007bff; /* M?u xanh n??c bi?n */
                box-shadow: 0 4px 12px rgba(0, 123, 255, 0.3); /* ?? b?ng xanh */
                transform: scale(1.05); /* Ph?ng to nh? */
            }

            /* ??m b?o ph?n n?i dung ch?nh lu?n ??y xu?ng d??i */
            .card-body1 {
                flex-grow: 1;
                display: flex;
                flex-direction: column;
            ...
            /* Ph?n ch?a n?t Buy/Tuyp lu?n ? d??i c?ng */
            .buttons {
                margin-top: auto; /* ??y l?n tr?n ?? lu?n n?m ? d??i c?ng */
                width: 100%;
                display: flex;
            ...
            .view-all {
                ...
                margin-right: 20px; /* T?o kho?ng c?ch v?i m?p ph?i */
            }

            .view-all:hover {
                color: #000; /* M?u ??m h?n khi hover */
            }
    ...
    <div id="navigation">
        ...
        <ul class="navigation-menu nav-left nav-light">
            <li><a href="ShipperDashBoardURL">Shipper </a></li>
...
<section class="bg-half-260 d-table w-100" 
         style="background: url('images/blog/pexels-artempodrez-4492065.jpg') center center no-repeat;
