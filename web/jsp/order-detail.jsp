...
<%@page import="entity.Products,java.util.Vector, entity.Categories, entity.CartItems, entity.Orders, model.DAOOrders, model.DAOProvinces, model.DAODistricts,  model.DAODeliveryAddress, model.DAOPayments, model.DAOCustomer, entity.Provinces" %>
...
<html lang="vi">
    ...
    <%
       ...
       Customers currentCustomer = (Customers) session.getAttribute("dataCustomer");
           ...
           Vector<Provinces> provinces = (Vector<Provinces>)request.getAttribute("provinces");
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container">
                                <table class="table table-hover table-striped mb-0 vertical-table">
                                    <tr>
                                        <th>Order Time</th>
                                    ...
                                    <tr>
                                        <th>Customer Name</th>
                                        <td><%=daoCus.getCustomer("select * from Customers c join Orders o on c.CustomerID = o.CustomerID where OrderID = " + order.getOrderID()).get(0).getFirstName()%></td>
                                    </tr>
                                    <tr>
                                        <th>Address</th>
                                        <td><%=pro.getProvinceByOrderID(order.getOrderID()).getProvinceName()%>, 
                                            <%=dis.getDistrictByOrderID(order.getOrderID()).getDistrictName()%>, 
                                            <%=deli.getDeliveryAddress("select * from DeliveryAddress where OrderID = " + order.getOrderID()).get(0).getAddressDetail()%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Phone</th>
                                        <td><%=deli.getDeliveryAddress("select * from DeliveryAddress where OrderID = " + order.getOrderID()).get(0).getPhone()%></td>
                                    </tr>
                                </table>
                                        ...
                                        <tr data-status="pending">
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <img src="images/products/<%=daoProduct.getProductImg(orderDetails.getProductID())%>" alt="" class="product-image">
                                                    <span><a href="ProductDetailURL?service=detailProduct&pid=<%=daoProduct.getProductByID(orderDetails.getProductID()).getProductID()%>"><%=daoProduct.getProductByID(orderDetails.getProductID()).getProductName()%></a></span>
                                                </div>
                                            </td>
