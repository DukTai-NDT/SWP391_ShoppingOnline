                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h3 class="sub-title mb-4">Shipper Dashboard</h3>
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-3">
                                <ul class="breadcrumb bg-light rounded mb-0 bg-transparent">
                                    ...
                                    <li class="breadcrumb-item"><a href="ShipperDashBoardURL">Shipper Dashboard</a></li>
                                ...
                                <table class="table table-hover table-striped mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-status="<%=statusClass%>">
                                            <td>
                                                <div class="">
                                                    <a href="OrderDetailURL?service=orderdetail&id=<%=order.getOrderID()%>"><%=order.getOrderID()%></a>
                                                </div>
                                            </td>

                                            <td>
                                                <%if(daoPay.getPaymentByOrderID(order.getOrderID()).isStatus()){%>
                                                ₫ 0 (Paid)
                                                <%}else {%>
