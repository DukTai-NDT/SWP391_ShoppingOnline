                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb" class="d-inline-block mt-1">
                                    <ul class="breadcrumb breadcrumb-muted bg-transparent rounded mb-0 p-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a href="OrderShipperURL">All Orders</a></li>
                                    </ul>
                                </nav>
                            </div>
                        ...
                        <div class="filter-container">
                            ...
                            <form action="OrderShipperURL">
                                <select name="time" class="filter-select">
                                    <option value="Newest">Newest</option>
                                    <option value="Oldest">Oldest</option>      
                                </select>

                                <select name="provinceName" class="filter-select">
                                ...
                                <button type="submit" name="submit" value="submit" class="filter-button" >Filter</button> 
                            </form>
                        </div>
                        <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-3">
                                                    ...
                                                    <a href="OrderShipperURL?service=pickOrder&oid=<%=order.getOrderID()%>&aid=<%=account.getAccountID()%>" class="btn btn-sm btn-danger">Choose</a>                
                                                </td>
