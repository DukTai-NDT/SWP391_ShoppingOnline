                    ...
                    <div class="product-info">
                        <div class="product-header">
                            ...
                            <div class="product-details">
                                <p><strong>Quantity: </strong> <a> <%=product.getQuantity()%></a></p>
                        ...
                        <div id="review-container" class="review">
                            ...
                            <div class="review-item">
                                ...
                                <div class="review-contents">
                                    ...
                                    <div>
                                        <a href="ProductDetailURL?service=deleteFeedback&feedid=<%=feedbacks.getFeedbackID()%>&proid=<%=product.getProductID()%>" class="btn btn-icon">X</a>
                                    </div>
                                    <%}%>
                                    <%}%>
