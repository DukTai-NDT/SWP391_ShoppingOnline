...
<%@page import="java.util.Vector, jakarta.servlet.http.HttpSession,entity.Customers"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <link
      href="/css/jquery.timepicker.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <!-- Icons -->
  ...
  <body>
          ...
          <li class="list-inline-item mb-0">
            ...
            >
              <div class="btn btn-icon btn-pills btn-primary">
                <i data-feather="settings" class="fea icon-sm"></i>
              </div>
            </a>
          </li>
          ...
          <li class="list-inline-item mb-0 ms-1">
            <div class="dropdown dropdown-primary">
              ...
              >
                ...
                <a class="dropdown-item text-dark" href="patient-dashboard.html"
                  ><span class="mb-0 d-inline-block me-1"
                    ><i class="uil uil-dashboard align-middle h6"></i
                  ></span>
                  Dashboard</a
                >
                <a class="dropdown-item text-dark" href="patient-profile.html"
                  ><span class="mb-0 d-inline-block me-1"
        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu nav-left">
            <li class="has-submenu parent-menu-item">
              ...
              <ul class="submenu">
                <li>
                  <a href="index.html" class="sub-menu-item">Index One</a>
                </li>
                <li>
                  <a href="index-two.html" class="sub-menu-item">Index Two</a>
                </li>
                <li>
            ...
            <li class="has-submenu parent-menu-item">
              ...
              <ul class="submenu">
                <li>
                  <a href="pharmacy.html" class="sub-menu-item">Pharmacy</a>
                </li>
                <li>
                  <a href="pharmacy-shop.html" class="sub-menu-item">Shop</a>
                </li>
                <li>
                  <a href="pharmacy-product-detail.html" class="sub-menu-item"
                    >Medicine Detail</a
                  >
                </li>
                <li>
                  <a href="pharmacy-shop-cart.html" class="sub-menu-item"
                    >Shop Cart</a
                  >
                </li>
                <li>
                  <a href="pharmacy-checkout.html" class="sub-menu-item"
                    >Checkout</a
                  >
                </li>
              </ul>
            ...
            <li class="has-submenu parent-parent-menu-item">
              ...
              <ul class="submenu">
                ...
                <li>
                  <a href="departments.html" class="sub-menu-item"
                    >Departments</a
                  >
                </li>
    ...
    <!-- Navbar End -->
<%
    Vector<Customers> vectorCustomer = (Vector<Customers>) request.getAttribute("vectorCustomer");
    HttpSession session = request.getSession();
    Integer customerId = (Integer) session.getAttribute("customerId");
    Customers currentCustomer = vectorCustomer != null && !vectorCustomer.isEmpty() ? vectorCustomer.get(0) : null;
%>
    <!-- Start -->
            ...
            <div class="rounded shadow overflow-hidden sticky-bar">
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h5 class="mt-3 mb-1"><%= currentCustomer != null ? currentCustomer.getFirstName() + " " + currentCustomer.getLastName() : "User" %></h5>
              </div>

              <div class="list-unstyled p-4">
                <div class="d-flex align-items-center mt-2">
                  <i
                    class="uil uil-user align-text-bottom text-primary h5 mb-0 me-2"
                  ></i>
                ...
                <div class="d-flex align-items-center mt-2">
                  <i
                    class="uil uil-envelope align-text-bottom text-primary h5 mb-0 me-2"
                  ></i>
                ...
                <div class="d-flex align-items-center mt-2">
                  <i
                    class="uil uil-book-open align-text-bottom text-primary h5 mb-0 me-2"
                  ></i>
                ...
                <div class="d-flex align-items-center mt-2">
                  <i
                    class="uil uil-italic align-text-bottom text-primary h5 mb-0 me-2"
                  ></i>
              ...
              <div class="col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                ...
                <ul class="list-unstyled footer-list mt-4">
                  <li class="d-flex align-items-center">
                    <i
                      data-feather="mail"
                      class="fea icon-sm text-foot align-middle"
                    ></i>
                    <a href="mailto:contact@example.com" class="text-foot ms-2"
                  ...
                  <li class="d-flex align-items-center">
                    <i
                      ...
                      class="fea icon-sm text-foot align-middle"
                    ></i>
                    <a href="tel:+152534-468-854" class="text-foot ms-2"
                      >+152 534-468-854</a
                    >
                  </li>
                  ...
                  <li class="d-flex align-items-center">
                    ...
                    <a
                      href="javascript:void(0)"
                      class="video-play-icon text-foot ms-2"
    ...
    <!-- Offcanvas Start -->
    <div
      class="offcanvas bg-white offcanvas-top"
      tabindex="-1"
      id="offcanvasTop"
    >
    ...
    >
                ...
                <ul class="text-center list-unstyled mb-0">
                  <li class="d-grid">
                    <a
                      ...
                      ><img
                        src="/images/layouts/landing-light-rtl.png"
                  ...
                  <li class="d-grid">
                    <a
                      ...
                      ><img
                        src="/images/layouts/landing-dark-rtl.png"
                        class="img-fluid rounded-md shadow-md d-block"
                        alt=""
                      /><span class="text-muted mt-2 d-block"
                        >RTL Version</span
                  ...
                  <li class="d-grid">
                    <a
                      ...
                      ><img
                        src="/images/layouts/landing-dark.png"
                        class="img-fluid rounded-md shadow-md d-block"
                        alt=""
                      /><span class="text-muted mt-2 d-block"
                        >LTR Version</span
                  ...
                  <li class="d-grid">
                    <a href="../admin/index.html" target="_blank" class="mt-4"
                      ><img
                        src="/images/layouts/light-dash.png"
                        class="img-fluid rounded-md shadow-md d-block"
                        alt=""
                      /><span class="text-muted mt-2 d-block"
      ...
      <div class="offcanvas-footer p-4 border-top text-center">
        <ul class="list-unstyled social-icon mb-0">
          ...
          <li class="list-inline-item mb-0">
            <a href="../../../index.html" target="_blank" class="rounded"
            ...
            <div class="row mb-4">
              <div class="col-lg-8 col-md-6">
                ...
                <small class="text-muted mb-0"
                  >1419 Riverwood Drive, <br />Redding, CA 96001</small
                >
              </div>
              <!--end col-->
              ...
              <div class="row">
                <div class="col-lg-8 col-md-6">
                  <h5 class="text-muted fw-bold">
                    Invoice
                    <span
                      class="badge badge-pill badge-soft-success fw-normal ms-2"
                      >Paid</span
                    >
                  </h5>
              ...
              <div class="invoice-table pb-4">
                  ...
                  <table class="table table-center invoice-tb mb-0">
                    <thead>
                      <tr>
                        <th
                          scope="col"
                          class="text-start border-bottom p-3"
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-5 ms-auto">
                    ...
                    >
                      <li
                        class="text-muted d-flex justify-content-between pe-3"
                      >
