...
<html lang="en">
    ...
    <%Vector<Categories> vcategories = (Vector<Categories>)request.getAttribute("vcategories");%>
    <%Vector<Products> vproduct = (Vector<Products>)request.getAttribute("vproduct");%>
    <% Vector<Products> vproductspecial= (Vector<Products>)request.getAttribute("vproductspecial");%>
    <%
