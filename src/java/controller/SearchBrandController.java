 ...
 * @author Admin
 */
@WebServlet(name = "SearchBrandController", urlPatterns = {"/SearchBrand"})
public class SearchBrandController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "select * from Brand where BrandName like N'%" + txt + "%'";
        Vector<Brand> vectorbrand = daobrand.getBrand(sql);
