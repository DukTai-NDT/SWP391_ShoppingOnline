 ...
 * @author whyth
 */
@WebServlet(name = "LoadDetailController", urlPatterns = {"/LoadDetail"})
public class LoadDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vector<Categories> category = cDAO.getCategories("SELECT * FROM dbo.Categories");
            Vector<Brand> brand = bDAO.getBrand("SELECT * FROM dbo.Brand");

            // Gửi dữ liệu đến JSP
            request.setAttribute("pLoadDetail", product);
            request.setAttribute("cLoadDetail", category);
            request.setAttribute("bLoadDetail", brand);
