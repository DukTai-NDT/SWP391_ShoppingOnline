 ...
 * @author Admin
 */
@WebServlet(name = "EditBrandController", urlPatterns = {"/EditBrand"})
public class EditBrandController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        daobrand.updateBrand(new Brand(id, brandName, country));
        response.sendRedirect("AdminBrands?message=Edit+Successfully");
    }
