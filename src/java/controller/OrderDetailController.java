    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("orderdetail")) {
                ...
                Vector<OrderDetails> vectorOrderDetail = daoOrderDetail.getOrderDetails("select * from Orderdetails\n"
                        + "where OrderID = " + id);
                Orders order = daoOrder.getOrders("select * from Orders where OrderID = " + id).get(0);
