 ...
 * @author Admin
 */
@WebServlet(name="ajaxServlet", urlPatterns={"/ajaxServletURL"})
public class ajaxServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int orderID = daoOrders.getLastOrderID();
        double amountDouble =daoOrderDetail.getTotalPriceOrder(orderID);
