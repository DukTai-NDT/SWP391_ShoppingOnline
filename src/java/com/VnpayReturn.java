 ...
 * @author Admin
 */
@WebServlet(name="VnpayReturn", urlPatterns={"/VnpayReturnURL"})
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (signValue.equals(vnp_SecureHash)) {
                ...
                payment.setPaymentID(daoPayment.getLastPaymentID());
                ...
                payment.setMethodID(2);
                daoPayment.updatePayment(payment);
